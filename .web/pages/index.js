...
useEffect(() => {
  ...
  return (
    <Toaster closeButton={false} expand={true} position={`bottom-right`} richColors={true} theme={resolvedColorMode}/>
        ...
        function ComponentMap_4ec133f2d0a0d02e0f670f572ce7ff90 () {
            const { resolvedColorMode } = useContext(ColorModeContext)
            return (
...
export function Flex_1bb875b7b7f3d0155dc05871929ebaef () {
  const { resolvedColorMode } = useContext(ColorModeContext)
  ...
  <ReactMarkdown className={`py-1`} rehypePlugins={[rehypeKatex, rehypeRaw]} remarkPlugins={[remarkMath, remarkGfm, remarkUnwrapImages]} components={ComponentMap_4ec133f2d0a0d02e0f670f572ce7ff90()}>
...
export default function Component() {
  ...
  <Flex_1bb875b7b7f3d0155dc05871929ebaef/>
  <NextHead>
  <title>
